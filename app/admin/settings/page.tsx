              ...
              <CardContent className="space-y-8">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div
                      className={`border rounded-lg p-4 cursor-pointer transition-colors ${payments.defaultMethod === "rfid"
                    ...
                    <div
                      className={`border rounded-lg p-4 cursor-pointer transition-colors ${payments.defaultMethod === "visa"
                          ? "border-purple-500 bg-purple-50"
                          : "border-gray-200 hover:border-purple-300"
                        }`}
                    ...
                    <div
                      className={`border rounded-lg p-4 cursor-pointer transition-colors ${payments.defaultMethod === "bank"
                          ? "border-purple-500 bg-purple-50"
                          : "border-gray-200 hover:border-purple-300"
                        }`}
